  ...
  angular.module('firebase').factory('$firebaseArray', ["$log", "$firebaseUtils", "$q",
    function($log, $firebaseUtils, $q) {
      ...
      FirebaseArray.prototype = {
        ...
        /**
         * Pass either an item in the array or the main of an item and it will be saved back
         ...
         * If passed an invalid main or an object which is not a record in this array,
        ...
        /**
         * Pass either an existing item in this array or the main of that item and it will
         ...
         * element. If passed an invalid main or an object which is not a record in this array,
         * the promise will be rejected.
         *
         * @param {int|object} indexOrItem
        ...
        /**
         * Given an item in this array or the main of an item in the array, this returns the
         ...
         * main in the array where that record is stored. If the record is not in the array,
